        ...
        public override bool Execute() {
            ...
            switch (CommandLineHelper.Argument("development")) {
                case "Development":
                    ...
                    Builder.Instance.buildOptions |= UnityEditor.BuildOptions.Development;
                    break;
                case "DeepProfiling":
                    Debug.Log("[Builder][AdjustBuildOptions] Debug: DeepProfiling Mode is enabled.");
                    Builder.Instance.buildOptions |= UnityEditor.BuildOptions.Development | UnityEditor.BuildOptions.EnableDeepProfilingSupport;
                    break;
            }

            switch (Builder.Instance.buildConfig.compression) {
                case BuildOptions.Compression.CompressWithLz4:
                    Debug.Log("[Builder][AdjustBuildOptions] Debug: Lz4 compression is enabled.");
                    Builder.Instance.buildOptions |= UnityEditor.BuildOptions.CompressWithLz4;
                    break;
                case BuildOptions.Compression.CompressWithLz4HC:
                    Debug.Log("[Builder][AdjustBuildOptions] Debug: Lz4HC compression is enabled.");
                    Builder.Instance.buildOptions |= UnityEditor.BuildOptions.CompressWithLz4HC;
                    break;
            }
            ...
            switch (Builder.Instance.BuildPlatform) {
                ...
                case BuildOptions.BuildPlatform.IOS:
                    if (!CommandLineHelper.ArgumentTrue("replaceMode")) {
                        ...
                        Builder.Instance.buildOptions |= UnityEditor.BuildOptions.AcceptExternalModificationsToPlayer;
                    }

                    if (CommandLineHelper.ArgumentTrue("debugMode") || CommandLineHelper.ArgumentTrue("testEnvironment")) {
#if UNITY_2021_1_OR_NEWER
                        Builder.Instance.buildOptions |= UnityEditor.BuildOptions.SymlinkSources;
#else
                        Builder.Instance.buildOptions |= UnityEditor.BuildOptions.SymlinkLibraries;
#endif
                    }
